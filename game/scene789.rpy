label scene7:
    ...
    # with dissolve
    me 2 serious "大家好！我是栗村医院感染管理科的杜鸿医师。这位是方岷医师。"
    ...
    me 2 serious "消毒中心的各位，关于我上午所查到的戊二醛消毒液的重大疏漏，相信你们也有所耳闻。"
    ...
    me 2 serious "你们不用担心，我不会追究你们的过错，这本质上是管理层的错误。但你们有义务为这次过错赎罪，因为如果未被发现的话……会造成你们难以想象的严重后果。"
    ...
    me 2 serious "很好，首先，我需要一部分人去查验医院里所有的消毒液浓度，并更换为正确浓度。"

    "根据零零星星举起的手，我选了几个，并让他们立刻去忙活，一刻也不能搁。"

    me 2 serious "方岷，你去监督他们。"
    ...
    me 2 serious "别高兴得太早。接下来，我会问你们几道关于医院卫生护理，也就是院感防控的题目。"

    # （◎立绘：潘叶：笑）#居中#
    panye "尽管问！我们都是接受过专业培训的。"

    me 2 serious "哦，那你知道七步洗手法吗？"
    ...
    # 【问题7】
    me 2 serious "那问题四，请问七步洗手法的“弓”这一步，也就是洗指背这一步，是在第几步完成的呢？"
    ...
    me 2 serious "好啊，那你还知道消毒和灭菌的区别吗？"

    panye "知道啊！"

    # 【问题8】

    me 2 serious "好，那问题五：根据斯伯尔丁分类法，下列哪项全部属于高度危险物品？"
    ...
    me 2 serious "……但并不代表你们就能疏忽了。最重要的不是考住你们，而是让你们把这些知识应用到日常工作中，切实地履行。"

    "众人都惭愧地面面相觑，恐怕是想起了那瓶戊二醛的事。"

    "我叹了口气。"

    me 2 serious "总之，我需要你们把曾经学过的知识再捡起来，越快越好，然后认真检查医院的每个角落，场所的消毒、医生的防护、手术的进行……"

    me 2 serious "从现在开始行动，一刻都不能耽搁。"
    ...
    # （◎立绘：药师）#居左#
    hide pharmaceutist with dissolve
    # （◎立绘：潘叶：严肃）#居右#
    show panye confused at right with dissolve
    panye "你怎么能这么说！"

    # （主角：立绘2：惊吓）
    # show duhong shocked at left with dissolve
    "我被吓了一跳，立马闭上嘴。"
    ...
    me 2 smile "那你们现在可以开始行动了。潘叶，你去监督他们。"
    # （◎立绘：潘叶：疑惑）#居中#
    show panye confused at center with dissolve
    panye "欸？那杜医生你……"
...
label scene8:
    ...
    me 2 serious "这是我今早拜托检验科测得的，我院使用的戊二醛消毒液的浓度说明。"

    "岳为缓缓地拿走报告单。"

    yuewei "0.1%%……"

    me 2 serious "您应该知道这不是正常的消毒液浓度吧？"
    ...
    me 2 serious "听消毒中心的人说，应该有半年了。"

    yuewei "半年都一直在使用错误浓度的消毒液吗？"

    me 2 serious "……是的。因为购入的戊二醛溶液上未标示有效浓度，所以大家都……"

    yuewei "原来采购部那边也有过失……"

    "我观察着他的脸色，继续开口。"

    me 2 serious "院长，这并不是我想向您报告的唯一的事。经过我的调查发现，这重大的过失根本上是源于医院的管理混乱。"

    yuewei "……"

    me 2 serious "院长，我有几个问题想要问您。"
    ...
    # 【问题9】
    me 2 serious "……好的。您知道医院感染三级护理管理体系分别为哪三级吗？"
    ...
    me 2 serious "医院感染三级护理管理体系的职责是评估医院感染发生的危险性，目的是及时发现，及时处理。"
    ...
    # 【问题10】
    me 2 serious "那院长，您知道对医疗废物收集、运送、贮存、处置活动中的环境污染防治工作实施统一监督管理的相关部门是什么吗？"
    ...
    menu:
        "环境保护主管部门":
            call correct from _call_correct_9
            "没错，这很容易混淆……医疗废物分类目录由卫生行政主管部门和环境保护主管部门共同制定，但统一监督管理部门为环境保护部。"
        "卫生行政主管部门":
            "不对，我也跳进了坑吗……要记得医疗废物分类目录由卫生行政主管部门和环境保护主管部门共同制定，但统一监督管理部门为环境保护部。"

    "我向岳为抛出最后一个问题。"

    me 2 serious "那院长，您了解院感防控所需完善的规章制度吗？"

    "他再次愣住了。但这次似乎并不是他忘记了，而是不敢说了。"

    me 2 serious "包括对院内各项消毒措施的管理、对消毒剂使用，感染高发科室等的及时监测、对感染源和易感人群的控制和保护、以及院内人员的院感防控知识教育，等等。"
...
label bad_ending:
    ...
    me 2 serious "……没错。我认为目前栗村的状况已经非常危险，错用半年的低浓度戊二醛溶液已经足够引起您的注意了。"
    ...
    # （◎立绘：岳为：闭眼）#居中#
    show yuewei eyeclosed at center
    with dissolve
    yuewei "你出去吧，为了避免检查时出意外，戊二醛的事情我会解决的。"

    me 2 angry "可是，医院从管理上就有问题，怎么是更换一下戊二醛就能解决的——"
    ...
    # scene bg grey
    # （◎立绘：潘叶：严肃）#居中#
    show panye confused single at right
    with dissolve
    "进来的是潘叶。"
    ...
    scene bg grey with dissolve
    # （主角：立绘2：呆滞）
    show duhong_sad at center with dissolve
    with dissolve
...
label scene9:
    ...
    "我很想像小孩子一样，哭着倾诉我对她的思念。"

    hide duhong_sad with dissolve

    # （◎立绘：尹青（立绘2：笑））#居中#
    show yinqing smile with pixellate

    "可是在尹青姐和她的孩子清澈的眼眸里，我看见了倒映出的我的身影。"
    ...
    me 2 serious "尹青姐，如果不是你，我根本不会这么明了地意识到医院感染的危害性……这是我们医务工作者，最容易忽略的隐患。"

    me 2 serious "尹青姐，就算我回去了，我也不会荒废我学过的、向栗村的大家传播过的院感防控知识。"

    me 2 serious "我会在我接下来的医者生涯中，继续传播它、宣扬它，不让那样的事故再次发生。"
    ...
    scene bg grey with dissolve
    show duhong_smile at center with dissolve
